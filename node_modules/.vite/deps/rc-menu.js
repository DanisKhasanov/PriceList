...
var supportRef = function supportRef2(nodeOrComponent) {
  ...
  if (typeof type === "function" && !((_type$prototype = type.prototype) !== null && _type$prototype !== void 0 && _type$prototype.render) && type.$$typeof !== import_react_is2.ForwardRef) {
    return false;
  }
...
function isReactElement(node) {
  return (0, import_react3.isValidElement)(node) && !(0, import_react_is2.isFragment)(node);
}
...
function InternalItem(props, ref) {
  ...
  var itemNode = React9.createElement(Component5, _extends({
  ...
  if (responsive) {
    itemNode = React9.createElement(es_default, {
...
var Item = React9.forwardRef(InternalItem);
...
function useEvent(callback) {
  var fnRef = React10.useRef();
  fnRef.current = callback;
  var memoFn = React10.useCallback(function() {
    var _fnRef$current;
...
var OverflowContext = import_react4.default.createContext(null);
...
var InternalRawItem = function InternalRawItem2(props, ref) {
  var context = React13.useContext(OverflowContext);
  if (!context) {
    var _props$component = props.component, Component5 = _props$component === void 0 ? "div" : _props$component, _restProps = _objectWithoutProperties(props, _excluded2);
    return React13.createElement(Component5, _extends({}, _restProps, {
      ref
    }));
  }
  ...
  return React13.createElement(OverflowContext.Provider, {
    value: null
  }, React13.createElement(Item_default, _extends({
    ref,
    className: (0, import_classnames2.default)(contextClassName, className)
  }, restContext, restProps)));
};
var RawItem = React13.forwardRef(InternalRawItem);
...
function Overflow(props, ref) {
  ...
  var mergedDisplayCount = React14.useMemo(function() {
  ...
  var getKey = (0, import_react5.useCallback)(function(item, index2) {
    var _ref;
  ...
  var internalRenderItemNode = renderRawItem ? function(item, index2) {
    ...
    return React14.createElement(OverflowContext.Provider, {
      key,
    ...
    var key = getKey(item, index2);
    return React14.createElement(Item_default, _extends({}, itemSharedProps, {
      order: index2,
      key,
      item,
  ...
  if (!renderRawRest) {
    ...
    restNode = React14.createElement(Item_default, _extends({}, itemSharedProps, restContextProps), typeof mergedRenderRest === "function" ? mergedRenderRest(omittedItems) : mergedRenderRest);
  } else if (renderRawRest) {
    restNode = React14.createElement(OverflowContext.Provider, {
      value: _objectSpread2(_objectSpread2({}, itemSharedProps), restContextProps)
    }, renderRawRest(omittedItems));
  }
  var overflowNode = React14.createElement(Component5, _extends({
    className: (0, import_classnames3.default)(!invalidate && prefixCls, className),
    style: style2,
    ref
  }, restProps), mergedData.map(internalRenderItemNode), showRest ? restNode : null, suffix && React14.createElement(Item_default, _extends({}, itemSharedProps, {
  ...
  if (isResponsive) {
    overflowNode = React14.createElement(es_default, {
...
var ForwardOverflow = React14.forwardRef(Overflow);
...
var IdContext = React16.createContext(null);
function getMenuId(uuid3, eventKey) {
  if (uuid3 === void 0) {
    return null;
  }
  return "".concat(uuid3, "-").concat(eventKey);
}
function useMenuId(eventKey) {
  var id = React16.useContext(IdContext);
...
function InheritableContextProvider(_ref) {
  ...
  var context = React17.useContext(MenuContext);
  var inheritableContext = useMemo(function() {
    return mergeProps(context, restProps);
  }, [context, restProps], function(prev, next) {
    return !locked && (prev[0] !== next[0] || !isEqual_default(prev[1], next[1], true));
  });
  return React17.createElement(MenuContext.Provider, {
...
var PrivateContext = React19.createContext({});
...
function useAccessibility(mode, activeKey, isRtl, id, containerRef, getKeys, getKeyPath, triggerActiveKey, triggerAccessibilityOpen, originOnKeyDown) {
  var rafRef = React20.useRef();
  var activeRef = React20.useRef();
...
function useKeyRecords() {
  var _React$useState = React21.useState({}), _React$useState2 = _slicedToArray(_React$useState, 2), internalForceUpdate = _React$useState2[1];
  var key2pathRef = (0, import_react6.useRef)(/* @__PURE__ */ new Map());
  var path2keyRef = (0, import_react6.useRef)(/* @__PURE__ */ new Map());
  var _React$useState3 = React21.useState([]), _React$useState4 = _slicedToArray(_React$useState3, 2), overflowKeys = _React$useState4[0], setOverflowKeys = _React$useState4[1];
  var updateRef = (0, import_react6.useRef)(0);
  var destroyRef = (0, import_react6.useRef)(false);
  var forceUpdate = function forceUpdate2() {
    if (!destroyRef.current) {
      internalForceUpdate({});
    }
  };
  var registerPath = (0, import_react6.useCallback)(function(key, keyPath) {
    if (true) {
  ...
  var unregisterPath = (0, import_react6.useCallback)(function(key, keyPath) {
    var connectedPath = getPathStr(keyPath);
    path2keyRef.current.delete(connectedPath);
    key2pathRef.current.delete(key);
  }, []);
  var refreshOverflowKeys = (0, import_react6.useCallback)(function(keys) {
    setOverflowKeys(keys);
  }, []);
  var getKeyPath = (0, import_react6.useCallback)(function(eventKey, includeOverflow) {
  ...
  var isSubPathKey = (0, import_react6.useCallback)(function(pathKeys, eventKey) {
  ...
  var getSubPathKeys = (0, import_react6.useCallback)(function(key) {
...
function useMemoCallback(func) {
  var funRef = React22.useRef(func);
  funRef.current = func;
  var callback = React22.useCallback(function() {
    var _funRef$current;
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
...
function useUUID(id) {
  var _useMergedState = useMergedState(id, {
    value: id
  }), _useMergedState2 = _slicedToArray(_useMergedState, 2), uuid3 = _useMergedState2[0], setUUID = _useMergedState2[1];
...
function useActive(eventKey, disabled, onMouseEnter, onMouseLeave) {
  var _React$useContext = React24.useContext(MenuContext), activeKey = _React$useContext.activeKey, onActive = _React$useContext.onActive, onInactive = _React$useContext.onInactive;
  var ret = {
...
function useDirectionStyle(level) {
  var _React$useContext = React25.useContext(MenuContext), mode = _React$useContext.mode, rtl = _React$useContext.rtl, inlineIndent = _React$useContext.inlineIndent;
  if (mode !== "inline") {
    return null;
  }
  var len = level;
...
function Icon(_ref) {
  ...
  if (typeof icon === "function") {
    iconNode = React26.createElement(icon, _objectSpread2({}, props));
...
var LegacyMenuItem = function(_React$Component) {
  ...
  _createClass(LegacyMenuItem2, [{
    ...
    value: function render() {
      ...
      return React27.createElement(es_default2.Item, _extends({}, attribute, {
...
var InternalMenuItem = React27.forwardRef(function(props, ref) {
  var _classNames;
  ...
  var _React$useContext2 = React27.useContext(PrivateContext_default), _internalRenderMenuItem = _React$useContext2._internalRenderMenuItem;
  var itemCls = "".concat(prefixCls, "-item");
  var legacyMenuItemRef = React27.useRef();
  ...
  var renderNode = React27.createElement(LegacyMenuItem, _extends({
  ...
  }), children, React27.createElement(Icon, {
...
function MenuItem(props, ref) {
  ...
  return React27.createElement(InternalMenuItem, _extends({}, props, {
    ref
  }));
}
var MenuItem_default = React27.forwardRef(MenuItem);
...
var InternalSubMenuList = function InternalSubMenuList2(_ref, ref) {
  ...
  var _React$useContext = React28.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, mode = _React$useContext.mode, rtl = _React$useContext.rtl;
  return React28.createElement("ul", _extends({
...
var SubMenuList = React28.forwardRef(InternalSubMenuList);
...
function parseChildren(children, keyPath) {
  return toArray(children).map(function(child, index2) {
    if (React29.isValidElement(child)) {
      ...
      return React29.cloneElement(child, cloneProps);
    }
    return child;
  });
}
...
var OrderContext = React30.createContext(null);
...
function useDom(render, debug) {
  ...
  var appendedRef = React31.useRef(false);
  var queueCreate = React31.useContext(Context_default);
  var _React$useState3 = React31.useState(EMPTY_LIST), _React$useState4 = _slicedToArray(_React$useState3, 2), queue = _React$useState4[0], setQueue = _React$useState4[1];
...
var Portal = React33.forwardRef(function(props, ref) {
  ...
  var _React$useState = React33.useState(open), _React$useState2 = _slicedToArray(_React$useState, 2), shouldRender = _React$useState2[0], setShouldRender = _React$useState2[1];
  ...
  var _React$useState3 = React33.useState(function() {
  ...
  if (ref) {
    reffedChildren = React33.cloneElement(children, {
      ref: mergedRef
    });
  }
...
var useId_default = useOriginId ? (
  ...
  function useCompatId(id) {
    var _React$useState = React34.useState("ssr-id"), _React$useState2 = _slicedToArray(_React$useState, 2), innerId = _React$useState2[0], setInnerId = _React$useState2[1];
...
function useSyncState(defaultValue) {
  var _React$useReducer = React37.useReducer(function(x) {
    return x + 1;
  }, 0), _React$useReducer2 = _slicedToArray(_React$useReducer, 2), forceUpdate = _React$useReducer2[1];
  var currentValueRef = React37.useRef(defaultValue);
...
var useNextFrame_default = function() {
  var nextFrameRef = React39.useRef(null);
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var eventHandlers = React41.useMemo(function() {
  ...
  var firstMountChangeRef = React41.useRef(false);
  (0, import_react9.useEffect)(function() {
    if (asyncVisible) {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React42.forwardRef(function(props, ref) {
    var _props$visible = props.visible, visible = _props$visible === void 0 ? true : _props$visible, _props$removeOnLeave = props.removeOnLeave, removeOnLeave = _props$removeOnLeave === void 0 ? true : _props$removeOnLeave, forceRender = props.forceRender, children = props.children, motionName = props.motionName, leavedClassName = props.leavedClassName, eventProps = props.eventProps;
    var _React$useContext = React42.useContext(Context), contextMotion = _React$useContext.motion;
    ...
    var setNodeRef = React42.useCallback(function(node) {
    ...
    if (React42.isValidElement(motionChildren) && supportRef(motionChildren)) {
      var _ref = motionChildren, originNodeRef = _ref.ref;
      if (!originNodeRef) {
        motionChildren = React42.cloneElement(motionChildren, {
          ref: setNodeRef
        });
      }
    }
    return React42.createElement(DomWrapper_default, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
...
// node_modules/rc-motion/es/CSSMotionList.js
var _excluded9 = ["component", "children", "onVisibleChanged", "onAllRemoved"];
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component5 = component || React43.Fragment;
        var motionProps = {};
        ...
        return React43.createElement(Component5, restProps, keyEntities.map(function(_ref2, index2) {
          var status = _ref2.status, eventProps = _objectWithoutProperties(_ref2, _excluded24);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return React43.createElement(CSSMotion, _extends({}, motionProps, {
            key: eventProps.key,
            visible,
            eventProps,
...
function Mask(props) {
  ...
  return React45.createElement(es_default4, _extends({}, motion, {
    motionAppear: true,
    visible: open,
    removeOnLeave: true
  }), function(_ref) {
...
var PopupContent = React46.memo(function(_ref) {
...
// node_modules/@rc-component/trigger/es/Popup/index.js
var Popup = React47.forwardRef(function(props, ref) {
  ...
  var _React$useState = React47.useState(!getPopupContainer || !getPopupContainerNeedParams), _React$useState2 = _slicedToArray(_React$useState, 2), show = _React$useState2[0], setShow = _React$useState2[1];
  useLayoutEffect_default(function() {
  ...
  return React47.createElement(Portal2, {
    open: forceRender || isNodeVisible,
    getContainer: getPopupContainer && function() {
      return getPopupContainer(target);
    },
    autoDestroy
  }, React47.createElement(Mask, {
    prefixCls,
    open,
    zIndex,
    mask,
    motion: maskMotion
  }), React47.createElement(es_default, {
    onResize: onAlign,
    disabled: !open
  }, function(resizeObserverRef) {
    return React47.createElement(es_default4, _extends({
      motionAppear: true,
      motionEnter: true,
      motionLeave: true,
      removeOnLeave: false,
      ...
      return React47.createElement("div", {
        ...
        onPointerEnter,
        onClick
      }, arrow && React47.createElement(Arrow, {
        prefixCls,
        arrow,
        arrowPos,
        align
      }), React47.createElement(PopupContent_default, {
        cache: !open && !fresh
      }, childNode));
    });
  }));
...
var TriggerWrapper = React48.forwardRef(function(props, ref) {
  var children = props.children, getTriggerDOMNode = props.getTriggerDOMNode;
  var canUseRef = supportRef(children);
  var setRef = React48.useCallback(function(node) {
    fillRef(ref, getTriggerDOMNode ? getTriggerDOMNode(node) : node);
  }, [getTriggerDOMNode]);
  var mergedRef = useComposeRef(setRef, children.ref);
  return canUseRef ? React48.cloneElement(children, {
    ref: mergedRef
  }) : children;
});
if (true) {
...
var TriggerContext = React49.createContext(null);
...
function useAction(mobile, action, showAction, hideAction) {
  return React50.useMemo(function() {
...
function useAlign(open, popupEle, target, placement, builtinPlacements, popupAlign, onPopupAlign) {
  ...
  var alignCountRef = React51.useRef(0);
  var scrollerList = React51.useMemo(function() {
    if (!popupEle) {
      return [];
    }
    return collectScroller(popupEle);
  }, [popupEle]);
  var prevFlipRef = React51.useRef({});
...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  var openRef = React52.useRef(open);
...
function generateTrigger() {
  ...
  var Trigger = React53.forwardRef(function(props, ref) {
    ...
    var _React$useState = React53.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), mobile = _React$useState2[0], setMobile = _React$useState2[1];
    useLayoutEffect_default(function() {
      setMobile(isMobile_default());
    }, []);
    var subPopupElements = React53.useRef({});
    var parentContext = React53.useContext(context_default);
    var context = React53.useMemo(function() {
      return {
    ...
    var _React$useState3 = React53.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), popupEle = _React$useState4[0], setPopupEle = _React$useState4[1];
    var externalPopupRef = React53.useRef(null);
    ...
    var _React$useState5 = React53.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), targetEle = _React$useState6[0], setTargetEle = _React$useState6[1];
    var externalForwardRef = React53.useRef(null);
    ...
    var child = React53.Children.only(children);
    ...
    var _React$useState7 = React53.useState(defaultPopupVisible || false), _React$useState8 = _slicedToArray(_React$useState7, 2), internalOpen = _React$useState8[0], setInternalOpen = _React$useState8[1];
    ...
    var openRef = React53.useRef(mergedOpen);
    openRef.current = mergedOpen;
    var lastTriggerRef = React53.useRef([]);
    ...
    var _React$useState9 = React53.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), inMotion = _React$useState10[0], setInMotion = _React$useState10[1];
    useLayoutEffect_default(function(firstMount) {
      if (!firstMount || mergedOpen) {
        setInMotion(true);
      }
    }, [mergedOpen]);
    var _React$useState11 = React53.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), motionPrepareResolve = _React$useState12[0], setMotionPrepareResolve = _React$useState12[1];
    var _React$useState13 = React53.useState([0, 0]), _React$useState14 = _slicedToArray(_React$useState13, 2), mousePos = _React$useState14[0], setMousePos = _React$useState14[1];
    ...
    var alignedClassName = React53.useMemo(function() {
    ...
    var _React$useState15 = React53.useState(0), _React$useState16 = _slicedToArray(_React$useState15, 2), targetWidth = _React$useState16[0], setTargetWidth = _React$useState16[1];
    var _React$useState17 = React53.useState(0), _React$useState18 = _slicedToArray(_React$useState17, 2), targetHeight = _React$useState18[0], setTargetHeight = _React$useState18[1];
    ...
    var triggerNode = React53.cloneElement(child, _objectSpread2(_objectSpread2({}, mergedChildrenProps), passedProps));
    var arrowPos = {
      x: arrowX,
      y: arrowY
    };
    var innerArrow = arrow ? _objectSpread2({}, arrow !== true ? arrow : {}) : null;
    return React53.createElement(React53.Fragment, null, React53.createElement(es_default, {
      disabled: !mergedOpen,
      ref: setTargetRef,
      onResize: onTargetResize
    }, React53.createElement(TriggerWrapper_default, {
      getTriggerDOMNode
    }, triggerNode)), React53.createElement(context_default.Provider, {
      value: context
...
function PopupTrigger(_ref) {
  ...
  var targetMotionRef = React54.useRef(targetMotion);
  if (mode !== "inline") {
  ...
  return React54.createElement(es_default5, {
    prefixCls,
...
function InlineSubMenuList(_ref) {
  ...
  var _React$useContext = React55.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, forceSubMenuRender = _React$useContext.forceSubMenuRender, motion = _React$useContext.motion, defaultMotions = _React$useContext.defaultMotions, mode = _React$useContext.mode;
  var sameModeRef = React55.useRef(false);
  sameModeRef.current = mode === fixedMode;
  var _React$useState = React55.useState(!sameModeRef.current), _React$useState2 = _slicedToArray(_React$useState, 2), destroy = _React$useState2[0], setDestroy = _React$useState2[1];
  ...
  return React55.createElement(InheritableContextProvider, {
  ...
  }, React55.createElement(es_default4, _extends({
    visible: mergedOpen
  }, mergedMotion, {
    forceRender: forceSubMenuRender,
    removeOnLeave: false,
    ...
    return React55.createElement(SubMenuList_default, {
      id,
...
// node_modules/rc-menu/es/SubMenu/index.js
var _excluded11 = ["style", "className", "title", "eventKey", "warnKey", "disabled", "internalPopupClose", "children", "itemIcon", "expandIcon", "popupClassName", "popupOffset", "popupStyle", "onClick", "onMouseEnter", "onMouseLeave", "onTitleClick", "onTitleMouseEnter", "onTitleMouseLeave"];
var _excluded25 = ["active"];
var InternalSubMenu = React56.forwardRef(function(props, ref) {
  var _classNames;
  ...
  var _React$useContext2 = React56.useContext(PrivateContext_default), _internalRenderSubMenuItem = _React$useContext2._internalRenderSubMenuItem;
  var _React$useContext3 = React56.useContext(PathUserContext), isSubPathKey = _React$useContext3.isSubPathKey;
  ...
  var _React$useState = React56.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), childrenActive = _React$useState2[0], setChildrenActive = _React$useState2[1];
  ...
  var mergedActive = React56.useMemo(function() {
    if (active) {
      return active;
    }
    if (mode !== "inline") {
  ...
  var titleNode = React56.createElement("div", _extends({
    role: "menuitem",
    ...
    onFocus: onInternalFocus
  }, activeProps), title, React56.createElement(Icon, {
  ...
  }, React56.createElement("i", {
    className: "".concat(subMenuPrefixCls, "-arrow")
  })));
  var triggerModeRef = React56.useRef(mode);
  ...
  if (!overflowDisabled) {
    ...
    titleNode = React56.createElement(PopupTrigger, {
      mode: triggerMode,
      ...
      popupOffset,
      popupStyle,
      popup: React56.createElement(
        InheritableContextProvider,
        {
          mode: triggerMode === "horizontal" ? "vertical" : triggerMode
        },
        React56.createElement(SubMenuList_default, {
          id: popupId,
          ref: popupRef
        }, children)
      ),
  ...
  var listNode = React56.createElement(es_default2.Item, _extends({
    ref,
    role: "none"
  }, restProps, {
    component: "li",
  ...
  }), titleNode, !overflowDisabled && React56.createElement(InlineSubMenuList, {
    id: popupId,
    open,
  ...
  return React56.createElement(InheritableContextProvider, {
...
var SubMenu = React56.forwardRef(function(props, ref) {
  ...
  if (measure) {
    ...
    renderNode = React56.createElement(InternalSubMenu, _extends({
      ref
    }, props), childList);
  }
  return React56.createElement(PathTrackerContext.Provider, {
...
function Divider(_ref) {
  ...
  return React57.createElement("li", {
    role: "separator",
...
var InternalMenuItemGroup = React58.forwardRef(function(props, ref) {
  var className = props.className, title = props.title, eventKey = props.eventKey, children = props.children, restProps = _objectWithoutProperties(props, _excluded12);
  var _React$useContext = React58.useContext(MenuContext), prefixCls = _React$useContext.prefixCls;
  var groupPrefixCls = "".concat(prefixCls, "-item-group");
  return React58.createElement("li", _extends({
    ref,
    role: "presentation"
  }, restProps, {
    ...
    title: typeof title === "string" ? title : void 0
  }, title), React58.createElement("ul", {
    role: "group",
    className: "".concat(groupPrefixCls, "-list")
  }, children));
});
var MenuItemGroup = React58.forwardRef(function(props, ref) {
  var eventKey = props.eventKey, children = props.children;
  var connectedKeyPath = useFullPath(eventKey);
  var childList = parseChildren(children, connectedKeyPath);
  var measure = useMeasure();
  ...
  return React58.createElement(InternalMenuItemGroup, _extends({
    ref
...
// node_modules/rc-menu/es/utils/nodeUtil.js
var _excluded13 = ["label", "children", "key", "type"];
function convertItemsToNodes(list, components) {
  ...
  return (list || []).map(function(opt, index2) {
    if (opt && _typeof(opt) === "object") {
      var _ref = opt, label = _ref.label, children = _ref.children, key = _ref.key, type = _ref.type, restProps = _objectWithoutProperties(_ref, _excluded13);
      var mergedKey = key !== null && key !== void 0 ? key : "tmp-".concat(index2);
      if (children || type === "group") {
        if (type === "group") {
          return React59.createElement(MergedMenuItemGroup, _extends({
            key: mergedKey
          }, restProps, {
            title: label
          }), convertItemsToNodes(children, components));
        }
        return React59.createElement(MergedSubMenu, _extends({
          key: mergedKey
        }, restProps, {
          title: label
        }), convertItemsToNodes(children, components));
      ...
      if (type === "divider") {
        return React59.createElement(MergedDivider, _extends({
          key: mergedKey
        }, restProps));
      }
      return React59.createElement(MergedMenuItem, _extends({
        key: mergedKey
      }, restProps), label);
    }
    return null;
...
var Menu = React60.forwardRef(function(props, ref) {
  ...
  var _React$useState = React60.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), mounted = _React$useState2[0], setMounted = _React$useState2[1];
  var containerRef = React60.useRef();
  var uuid3 = useUUID(id);
  ...
  var _React$useState3 = React60.useState(mergedOpenKeys), _React$useState4 = _slicedToArray(_React$useState3, 2), inlineCacheOpenKeys = _React$useState4[0], setInlineCacheOpenKeys = _React$useState4[1];
  var mountRef = React60.useRef(false);
  var _React$useMemo3 = React60.useMemo(function() {
  ...
  var _React$useState5 = React60.useState(mergedMode), _React$useState6 = _slicedToArray(_React$useState5, 2), internalMode = _React$useState6[0], setInternalMode = _React$useState6[1];
  var _React$useState7 = React60.useState(mergedInlineCollapsed), _React$useState8 = _slicedToArray(_React$useState7, 2), internalInlineCollapsed = _React$useState8[0], setInternalInlineCollapsed = _React$useState8[1];
  ...
  var _React$useState9 = React60.useState(0), _React$useState10 = _slicedToArray(_React$useState9, 2), lastVisibleIndex = _React$useState10[0], setLastVisibleIndex = _React$useState10[1];
  ...
  var registerPathContext = React60.useMemo(function() {
    return {
      registerPath,
      unregisterPath
    };
  }, [registerPath, unregisterPath]);
  var pathUserContext = React60.useMemo(function() {
    return {
      isSubPathKey
    };
  }, [isSubPathKey]);
  ...
  (0, import_react11.useImperativeHandle)(ref, function() {
    return {
      ...
      focus: function focus(options) {
        var _childList$find;
        var keys = getKeys();
        var _refreshElements = refreshElements(keys, uuid3), elements = _refreshElements.elements, key2element = _refreshElements.key2element, element2key = _refreshElements.element2key;
  ...
  var onInternalKeyDown = useAccessibility(internalMode, mergedActiveKey, isRtl, uuid3, containerRef, getKeys, getKeyPath, setMergedActiveKey, triggerAccessibilityOpen, onKeyDown);
  React60.useEffect(function() {
    setMounted(true);
  }, []);
  var privateContext = React60.useMemo(function() {
    return {
  ...
  var wrappedChildList = internalMode !== "horizontal" || disabledOverflow ? childList : (
    ...
    childList.map(function(child, index2) {
      return (
        ...
        React60.createElement(InheritableContextProvider, {
          key: child.key,
  ...
  var container = React60.createElement(es_default2, _extends({
    id,
    ref: containerRef,
    prefixCls: "".concat(prefixCls, "-overflow"),
    component: "ul",
    itemComponent: MenuItem_default,
    className: (0, import_classnames15.default)(prefixCls, "".concat(prefixCls, "-root"), "".concat(prefixCls, "-").concat(internalMode), className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-inline-collapsed"), internalInlineCollapsed), _defineProperty(_classNames, "".concat(prefixCls, "-rtl"), isRtl), _classNames), rootClassName),
    dir: direction,
    style: style2,
    role: "menu",
    tabIndex,
    ...
    renderRawRest: function renderRawRest(omitItems) {
      ...
      return React60.createElement(SubMenu_default, {
  ...
  return React60.createElement(PrivateContext_default.Provider, {
    value: privateContext
  }, React60.createElement(IdContext.Provider, {
    value: uuid3
  }, React60.createElement(InheritableContextProvider, {
    prefixCls,
    rootClassName,
  ...
  }, React60.createElement(PathUserContext.Provider, {
    value: pathUserContext
  }, container), React60.createElement("div", {
    style: {
      display: "none"
    },
    "aria-hidden": true
  }, React60.createElement(PathRegisterContext.Provider, {
...
export {
  ...
  MenuItemGroup_default as ItemGroup,
  MenuItem_default as MenuItem,
  MenuItemGroup_default as MenuItemGroup,
  SubMenu_default as SubMenu,
  es_default6 as default,
  useFullPath
};
